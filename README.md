...
The packaged plugin is written to `build/distributions/rulescribe-0.9.0.zip`.
...
The zip lands in the same place: `build/distributions/rulescribe-0.9.0.zip`.
...
3. Select `build/distributions/rulescribe-0.9.0.zip`
...
4. ⚠️ GitHub wraps artifacts in an extra zip: **extract**
   `rulescribe.zip` to get `rulescribe-0.9.0.zip`
